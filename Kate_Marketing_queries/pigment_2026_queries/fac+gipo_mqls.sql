    ...
    0 AS PQLs
    FROM test.cj_mqls_monthly_clinics
WHERE lifecycle_stage != 'only_won' AND month BETWEEN '2024-06-01' AND '2025-06-01'
AND mql_product IS NOT NULL AND mql_product IN ('Clinic Agenda', 'Gipo') AND country IN ('Colombia', 'Spain', 'Mexico', 'Brazil', 'Italy', 'Poland')
